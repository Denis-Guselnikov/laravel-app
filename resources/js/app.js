...
//Vue.component('example-component', require('./components/ExampleComponent.vue').default);  Регистрация компонента
...
const app = new Vue({
    ...
    created() {
        ...
        this.$store.dispatch('getArticleData', slug);  // dispatch используется для вызова action
